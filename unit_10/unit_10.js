...
let ar2 = ['qa', 'vb', 5, 9, 'qwe', true, false];
...
function f9 () {
    ...
    let lastElementAr9 = ar9[ar9.length - 1];

    out9.innerHTML = lastElementAr9;
}
...
function f10 () {
    ...
    let lastElementAr10 = ar10[ar10.length - 1];
    let sum = ar10[1] + lastElementAr10;
...
function f11 () {
    ...
    let elementArrIndex2 =  ar11[2];
    let str = '';

    ar11 [2] = ar11 [4];
    ar11 [4] = elementArrIndex2;
...
function f12() {
    ...
    let firstElementArr12 = ar12[0];
    let str = '';


    ar12[0] = ar12[ar12.length -1];
    ar12[ar12.length - 1] = firstElementArr12;
...
function f16() {
    ...
    for (let i = 0; i < ar16.length; i++) {
        if (ar16[i] % 2 ==  0) {
            ar16_odd[evenIndex] = ar16[i] + ' ';
            evenIndex++
        } else {
            ar16_even[oddIndex] = ar16[i] + ' ';
            oddIndex++
        }
    }
