...
function f6() {
    ...
    let classP6 = document.querySelectorAll('.p-6');

    out6.innerHTML = classP6.length;
}
...
function f18() {
    ...
    let attributeP18 = p18.getAttribute('data-b');

    out18.innerHTML = attributeP18;
}
