...
function f4() {
    let checkboxTask4 = document.querySelector('.i-4');
    let outTask4 = document.querySelector('.out-4');

    if (checkboxTask4.checked) {
        outTask4.innerHTML = 'true'
    } else {
        outTask4.innerHTML = 'false'
    }
}
...
function f5() {
    let checkboxTask5 = document.querySelector('.i-5');
    let checkboxTask5Value = checkboxTask5.value;
    let outTask5 = document.querySelector('.out-5');

    if (checkboxTask5.checked) {
        outTask5.innerHTML = checkboxTask5Value;
    } else {
        outTask5.innerHTML = 'false'
    }
}
...
function f6() {
    ...
    let inputTask6Value = inputTask6.value;
    let outTask6 = document.querySelector('.out-6');
    
    outTask6.innerHTML = inputTask6Value;
}
...
function f7() {
    ...
    let inputTask7Value = inputTask7.value;
    let outTask71 = document.querySelector('.out-71');
    let outTask72 = document.querySelector('.out-72');

    outTask71.innerHTML = inputTask7Value;

    if (inputTask7Value.length >= 6) {
        outTask72.innerHTML = '1';
    } else {
        outTask72.innerHTML = '0';
    }
}
...
function f8() {
    ...
    divTask8.innerHTML = '<input type="text" class="i-81">';
    divTask8.innerHTML += '<button class="b-81">Task-8-1</button>';
    divTask8.innerHTML += '<div class="out-81"></div>';

    let btnTask81 = document.querySelector('.b-81');

    btnTask81.onclick = f81;

    function f81 () {
        let outTask81 = document.querySelector('.out-81');
        let inputTask81 = document.querySelector('.i-81');
        let inputTask81Value = inputTask81.value;

        outTask81.innerHTML = inputTask81Value;
    }
}
...
function f9() {
    let inputTask9 = document.querySelector('.r-9');
    let inputTask9Value = inputTask9.value;
    let outTask9 = document.querySelector('.out-9');

    if (inputTask9.checked) {
        outTask9.innerHTML = inputTask9Value;
    }   else {
        outTask9.innerHTML = '0';
    }
}
...
function f10() {
    let inputTask10 = document.querySelector('.i-10');
    let inputTask10Value = inputTask10.value;
    let outTask10 = document.querySelector('.out-10');

    outTask10.style.backgroundColor = inputTask10Value;
}
...
function f11() {
    let inputTask111 = document.querySelector('.i-111');
    let inputTask112 = document.querySelector('.i-112');
    
    inputTask112.value = inputTask111.value;
}
...
function f12() {
    let inputTask12 = document.querySelector('.i-12');
    let out12 = document.querySelector('.out-12');

    out12.innerHTML = inputTask12.value;
}
...
function f13() {
    let inputTask13 = document.querySelector('.i-13');
    let out13 = document.querySelector('.out-13');

    out13.innerHTML = inputTask13.value;
}
...
function f14() {
    let textАrea14 = document.querySelector('.t-14');
    let out14 = document.querySelector('.out-14');

    out14.innerHTML = textАrea14.value;
}
...
function f15() {
    let textАrea15 = document.querySelector('.t-15');
    let inputTask15 = document.querySelector('.i-15');
    let out15 = document.querySelector('.out-15');

    textАrea15.value = inputTask15.value;
    out15.innerHTML = inputTask15.value;
}
...
function f18() {
    ...
    let inputTask18 = document.querySelector('.i-18');

    inputTask18.value = select18.value;
}
...
function f19() {
    let inputTask191 = document.querySelector('.i-191');
    let inputTask192 = document.querySelector('.i-192');
    let out19 = document.querySelector('.out-19');

    out19.innerHTML = inputTask191.value + ' ';
    out19.innerHTML += inputTask192.value;
}

document.querySelector('.b-19').onclick = f19;

// Task 20
// Создайте форму .f-20. В ней input(text) и input(password) - и кнопку button.b-10. По нажатию кнопки выводите значение из input text и password в out-20 через пробел. Используйте form.elements (читать)
...
function f20(e) {
    ...
    let inputText20 = form.elements.username;
    let inputPassword20 = form.elements.password;
    
    out20.innerHTML = inputText20.value + ' ';
    out20.innerHTML += inputPassword20.value;
}
