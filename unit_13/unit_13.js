...
function f6() {
    let input61 = document.querySelector('.i-61');
    let input62 = document.querySelector('.i-62');
    let inputValue61 = input61.value;
    let inputValue62 = input62.value;

    a6[inputValue61] = inputValue62;
    f5(a6, '.out-6');
}
...
function f12() {
    ...
    let inputValue12 = input12.value;

    for (let key in a12) {
        if (a12[key] == inputValue12) {
            delete a12[key]
        }
    }
