...
function t2() {
  ...
  fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Oleg')
    .then(data => {
      return data.text();
    })
    .then(data => {
...
function t4() {
  ...
  fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=0&num2=5')
    .then(data => {
      return data.text();
    })
    .then(data => {
...
function t6() {
  ...
  fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=0&num2=5')
    .then(data => {
      return data.text();
    })
    .then(data => {
...
function t10() {
  ...
  fetch('http://getpost.itgid.info/index2.php', {
    ...
    body: 'auth=5ADcB96BA48d3f80&action=1' // body data type must match "Content-Type" header
    })
    .then(response => {
...
function t11() {
  ...
  fetch('http://getpost.itgid.info/index2.php', {
    ...
    redirect: 'follow', // manual, *follow, error
    referrerPolicy: 'no-referrer', // no-referrer, *client
    body: 'auth=5ADcB96BA48d3f80&action=2&name=Oleg' // body data type must match "Content-Type" header
    })
    .then(response => {
    return response.text();
    })
...
function t12() {
  ...
  fetch('http://getpost.itgid.info/index2.php', {
    ...
    redirect: 'follow', // manual, *follow, error
    referrerPolicy: 'no-referrer', // no-referrer, *client
    body: 'auth=5ADcB96BA48d3f80&action=3&num1=1&num2=25' // body data type must match "Content-Type" header
    })
    .then(response => {
    return response.text();
    })
...
function t13() {
  ...
  fetch('http://getpost.itgid.info/index2.php', {
    ...
    redirect: 'follow', // manual, *follow, error
    referrerPolicy: 'no-referrer', // no-referrer, *client
    body: 'auth=5ADcB96BA48d3f80&action=4&num1=1&num2=25' // body data type must match "Content-Type" header
    })
    .then(response => {
    return response.text();
    })
...
function t15() {
  ...
  fetch('http://getpost.itgid.info/index2.php', {
    ...
    redirect: 'follow', // manual, *follow, error
    referrerPolicy: 'no-referrer', // no-referrer, *client
    body: 'auth=5ADcB96BA48d3f80&action=6&num1=1&num2=25' // body data type must match "Content-Type" header
    })
    .then(response => {
    return response.text();
    })
...
function t18() {
  ...
  fetch('http://getpost.itgid.info/index2.php', {
    ...
    redirect: 'follow', // manual, *follow, error
    referrerPolicy: 'no-referrer', // no-referrer, *client
    body: 'auth=5ADcB96BA48d3f80&action=9&m=1&d=1&y=1' // body data type must match "Content-Type" header
    })
    .then(response => {
      return response.text();
    })
